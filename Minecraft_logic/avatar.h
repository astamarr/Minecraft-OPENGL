...
public:
	...
	void DoSomething()
	{
		bool blob = World->getRayCollision(Position, Position + (Cam->_Direction) * 30 , CollisionIntersect, CollisionCubeX, CollisionCubeY, CollisionCubeZ);
		if (blob == true)
		{
			World->deleteCube(CollisionCubeX, CollisionCubeY, CollisionCubeZ);
